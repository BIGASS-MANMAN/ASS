#include "/usr/local/Auto_Scoring_System/Assignment/Project1/2013722021_정무영/AlphabetBST.h"
#include "/usr/local/Auto_Scoring_System/Assignment/Project1/2013722021_정무영/AlphabetNode.h"
#include "/usr/local/Auto_Scoring_System/Assignment/Project1/2013722021_정무영/CircularLinkedList.h"
#include "/usr/local/Auto_Scoring_System/Assignment/Project1/2013722021_정무영/Manager.h"
#include "/usr/local/Auto_Scoring_System/Assignment/Project1/2013722021_정무영/Queue.h"
#include "/usr/local/Auto_Scoring_System/Assignment/Project1/2013722021_정무영/WordBST.h"
#include "/usr/local/Auto_Scoring_System/Assignment/Project1/2013722021_정무영/WordNode.h"
...
TEST_F(Project1Test,run_TestCase4){
	...
	EXPECT_STREQ(Get_Print(M1),"");
}
TEST_F(Project1Test,run_TestCase5){
	M1.run("/usr/local/Auto_Scoring_System/info/Project1/Scenario5.txt");
	EXPECT_STREQ(Get_Print(M1),"");
}
