#include "/usr/local/Auto_Scoring_System/Assignment/BST/2012722060/Node.h"
#include "/usr/local/Auto_Scoring_System/Assignment/BST/2012722060/BST.h"
...
TEST_F(BSTTest,Delete_Death_test_Infinite_0)
{
