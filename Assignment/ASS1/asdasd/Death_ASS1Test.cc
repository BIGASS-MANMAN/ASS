#include "/usr/local/Auto_Scoring_System/Assignment/ASS1/asdasd/ALP_BST.h"
#include "/usr/local/Auto_Scoring_System/Assignment/ASS1/asdasd/Alphabet.h"
#include "/usr/local/Auto_Scoring_System/Assignment/ASS1/asdasd/CircularQueue.h"
#include "/usr/local/Auto_Scoring_System/Assignment/ASS1/asdasd/Manager.h"
#include "/usr/local/Auto_Scoring_System/Assignment/ASS1/asdasd/Queue.h"
#include "/usr/local/Auto_Scoring_System/Assignment/ASS1/asdasd/WORD_BST.h"
#include "/usr/local/Auto_Scoring_System/Assignment/ASS1/asdasd/Word.h"
